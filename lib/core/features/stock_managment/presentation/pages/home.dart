...
import 'package:dream_pedidos/core/features/stock_managment/presentation/pages/refill_report_screen.dart';
import 'package:dream_pedidos/core/features/stock_managment/presentation/pages/stock_screen.dart';
import 'package:dream_pedidos/core/features/stock_managment/presentation/pages/upload_sales_screen.dart';
...
class HomePage extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: BlocBuilder<BottomNavcubit, int>(
          builder: (context, state) {
            ...
            return Text(appBarsTitle[state]); // Dynamically set the title
          },
        ),
        centerTitle: true,
      ),
  ...
  void _showConfigurationDialog(BuildContext outerContext) {
    ...
    final fileEscandallosBloc = outerContext.read<RecipeParserBloc>();
